...
export const IdCardData = {
  imageLink: "https://i.imgur.com/NthO4FX.png",
  imageSrc: "https://i.imgur.com/NthO4FX.png",
  imageAlt: "Id Card-picture",
  appName: "Id Card Store",
  technologyUsed:
    "React JS,Redux/Redux Toolkit, Semantic UI, Node JS, and Koa Express",
  description:
    "This store has 2 systems, Admin Web Panel, and Customer Website where they can buy the products",
  paymentLink: "",
  paymentName: "",
};
